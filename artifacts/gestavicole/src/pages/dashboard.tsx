...
export default function Dashboard() {
  ...
  const kpis = [
    ...
    { label: "Total Animaux", value: (stats?.totalAnimalsRemaining || 0).toLocaleString(), icon: Target, color: "text-emerald-600", bg: "bg-emerald-100", suffix: "", sold: stats?.totalAnimalsSold || 0, remaining: null },
  ...
  return (
    <AppLayout>
      <div className="mb-8">
        <h1 className="text-xl lg:text-3xl font-display font-bold text-slate-900">Vue d'ensemble</h1>
