...
export default function Dashboard() {
  ...
  const kpis = [
    ...
    { label: "Animaux Actifs", value: (stats?.totalAnimals || 0).toLocaleString(), icon: Target, color: "text-emerald-600", bg: "bg-emerald-100", suffix: "", sold: stats?.totalAnimalsSold || 0, remaining: null },
